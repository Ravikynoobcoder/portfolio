  ...
  const socials = [
    {
      ...
      label: "GitHub",
      link: "https://github.com/Ravikynoobcoder/",
    },
    {
      icon: <Linkedin className="w-5 h-5" />,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/ravi-yadav7777/",
    },
    {
      icon: <Instagram className="w-5 h-5" />,
      label: "Instagram",
      link: "https://instagram.com/r",
    },
    {
      icon: <MessageCircle className="w-5 h-5" />,
      label: "WhatsApp",
      link: "https://wa.me/8318741692",
    },
    {
      icon: <Twitter className="w-5 h-5" />,
      label: "X",
      link: "https://x.com/ravikumar",
    },
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
          <a
            href="https://mail.google.com/mail/?view=cm&to=raviy3083@gmail.com"
